...
//
#ifndef G4CASCADEParticleHPManager_h
#define G4CASCADEParticleHPManager_h 1
...
{
   public:
      static G4CASCADEParticleHPManager* GetInstance();

   private: 
      G4CASCADEParticleHPManager();
      G4CASCADEParticleHPManager( const G4CASCADEParticleHPManager& ){};
      ~G4CASCADEParticleHPManager();
      static G4CASCADEParticleHPManager* instance;
   ...
   private:
      ...
      G4CASCADEParticleHPMessenger* messenger;
