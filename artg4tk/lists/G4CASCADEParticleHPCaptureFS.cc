...
//Added for CASCADE:
#include "artg4tk/lists/G4CASCADE.hh"

G4CASCADE* cascade = new G4CASCADE();

  G4HadFinalState * G4CASCADEParticleHPCaptureFS::ApplyYourself(const G4HadProjectile & theTrack)
  {
...
//Add photons
       ...
       {
              //G4cout << "TKDB G4CASCADEParticleHPCaptureFS::ApplyYourself we will create additional " << nPhotons - nNonZero << " photons" << G4endl;
...
#include <sstream> 
  void G4CASCADEParticleHPCaptureFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String &, G4ParticleDefinition* )
  {
